...
<template>
  <Teleport to="body">
    ...
    >
      ...
      <div
        class="inline-block h-[calc(100%-theme(spacing.8))] w-full overflow-hidden rounded-b-xl border-2 border-t-0 bg-white shadow-2xl"
      >
      ...
      <div
        class="resizeArea absolute left-2 top-2 -z-10 h-full w-full select-none rounded-2xl bg-black opacity-0 hover:opacity-40"
        ref="$resizeArea"
      ></div>
    </div>
  </Teleport>
